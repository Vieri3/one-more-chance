...
<template>
    <!--картинка героя-->
        <div v-if="props.idHero == 0" class="bg-gray-700/60">
            <img src="/different/specifications-heroes.png" alt="specifications-heroes">
        </div>
        <div v-else
            ...
            <div
                ...
                <img :src="'/heroes/' + objHero.thumbnail + '.png'" :alt="objHero.name">
            </div>
            <!-- Имя героя -->
            <div
